...
const CartPage = () => {
  ...
  const product = useSelector((state) => state.amazonReducer.products);
  ...
  const handleProceed = async () => {
    if (userId) {
      ...
      // Redirect to sign-in page or show a prompt
      ...
      {product.length > 0 ? (
        <div className="container mx-auto h-auto grid grid-cols-5 gap-8">
          <div className="w-full bg-white px-4 col-span-5 xl:col-span-4">
            <div className="hidden xl:flex items-center justify-between border-b-[1px] border-b-gray-400 py-3">
